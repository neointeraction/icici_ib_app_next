...
const data = [
  {
    ...
    body: `
    The Personal Information that we collect from the Provider of Information may include information that is 
    of a confidential nature, and shall mean and include any information that relates to a person, which either 
    directly or indirectly, in combination with other information that is available or likely to be available to Us, 
    is capable of identifying the Provider of the Information (“Personal Information”).

    The type of Personal Information collected from the Provider and covered under this Privacy Policy shall include 
    ...
    • Financial information (pertaining to the investments/ applications/ transactions and any other related purposes 
      vide which we would be providing the services to the Investors); and
    • Any other information as defined under Rule 3 of the Information Technology (Reasonable security practices 
      and procedures and sensitive personal data or information) Rules, 2011, as may be required by Us from time to 
      time in order to provide services to the Provider of Information. 
  ...
  },
  {
    ...
    body: `
    Personal Information is collected and/or obtained by Us from several sources, wherein the Provider of Information 
    has provided for the same. The information provided may include such Personal Information as a part of the 
    application and/or enrollment process (the same maybe online or vide a physical application form). Additionally,
    we may obtain the Personal Information from third-parties, or though call recordings at our call-centers, internet 
    technology, including our Website. 
    ...
    The Provider of Information agrees and understands that the Personal Information collected by Us shall be processed, 
    stored and used by Us, and the same may also be passed to, transmitted to and processed by our affiliates and other 
  ...
  },
  {
    title: "Legal Basis",
    body: ` 
    We are permitted to process your personal data in compliance with Data Protection Legislation by relying on one or 
    more of the lawful grounds.
    1.You have explicitly agreed to us processing such information for a specific reason;
    2.The processing is necessary to perform the agreement we have with you or to take steps to enter into an agreement
      with you;
    ...
    7.to keep our customers informed about their investments, unless you have indicated at any time that you do not wish us
      to do so
  ...
  },
  {
    title: "Purpose",
    body: ` 
    We and our affiliates including RTA (Registrar and Transfer Agent) may use your information for the purpose 
    as mentioned in clause above and/or for the below legal basis:
    ...
    4.to help you manage your account, meet our regulatory obligations and/or requirements, to keep you informed about 
      the product and service you hold with us;
    5.to assess any application you make, including carrying out anti- fraud, suspicious transactions check and any 
